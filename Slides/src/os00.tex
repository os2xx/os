...
\begin{itemize}
\item You have got two (2) ''spare'' assignments.
      \textbf{That is more than enough!}
\item Do not request remedial to the Lecturer.
\item Do not request a deadline extension.
\item Do not give lame excuses.
\item Do contact your Academic Advisor!
\end{itemize}
...
\includegraphics[width=0.84\linewidth]{os-xiaomi-black-shark-2-pro}
...
\item No fab: Marvell Technology, Inc (1995).
...
\begin{figure}
\includegraphics[width=0.43\linewidth]{os00-xapic}
