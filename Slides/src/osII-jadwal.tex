%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% REV368 Mon 07 Feb 2022 16:47:08 WIB
...
\begin{frame}[fragile]
\section{OS221 Schedule}
\frametitle{OS221\footnote{%
) This information will be on \textbf{EVERY} page two (2) of this course material.}): 
Operating Systems Schedule 2022 - 1}
...
\hline
Week 00  & Overview 1, Virtualization \& Scripting & Ch. 1, 2, 18. \\
...
\begin{itemize}
\item[$\square$] \href{https://scele.cs.ui.ac.id/course/view.php?id=3313}{\textbf{SCELE OS221}} ---
\url{https://scele.cs.ui.ac.id/course/view.php?id=3313}.\\
The enrollment key is \textbf{XXX}.
\item[$\square$] \textbf{Download Slides and Demos from GitHub.com} \\
\url{https://github.com/os2xx/os/}
