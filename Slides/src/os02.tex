...
\item \url{https://youtu.be/CivG_2UqKMg} (Corporate Culture/the first 30 minutes).
\begin{itemize}
...
\item The Beginner’s Guide To Internet Safety and Privacy --- \href{http://choosetoencrypt.com/privacy/complete-beginners-guide-to-internet-safety-privacy/}{LINK}.
\begin{itemize}
...
\item Visit
\url{https://github.com/os2xx/os/tree/master/Demos/}
\end{itemize}
\end{frame}
