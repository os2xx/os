...
% REV366 Sat 05 Feb 2022 10:16:09 WIB
...
\begin{frame}{Outline}
  \frametitle{Agenda}
  \tableofcontents[sections={1-17}]
\end{frame}
\begin{frame}
   \frametitle{Agenda (2)}
   \tableofcontents[sections={18-}]
\end{frame}
...
\section{The Computing Diciplines}
\begin{frame}[fragile]
...
\begin{figure}
\includegraphics[width=0.56\linewidth]{os-transfer-rate}
\end{figure}
\begin{itemize}
...
\item Each assignment deadline will be by the end of that ''week''. 
      The weekly schedule will be at \url{https://os.vlsm.org/}.
